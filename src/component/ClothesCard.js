...
export default function StudyCard() {
  ...
  <Dialog  sx={{minWidth:300}} open={open} onClose={handleClose}>
    <DialogTitle>{editItem !== null ? 'Edit ' : 'Clothes'}</DialogTitle>
    <DialogContent>
      <TextField autoFocus fullWidth label="Clothes" value={inputValue} onChange={(e) => setInputValue(e.target.value)} />
    </DialogContent>
