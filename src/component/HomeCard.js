...
export default function StudyCard() {
  ...
  <Dialog  sx={{minWidth:300}} open={open} onClose={handleClose}>
    <DialogTitle>{editItem !== null ? 'Edit ' : 'Home'}</DialogTitle>
    <DialogContent>
      <TextField autoFocus fullWidth label="Home" sx={{margin:10}} value={inputValue} onChange={(e) => setInputValue(e.target.value)} />
    </DialogContent>
